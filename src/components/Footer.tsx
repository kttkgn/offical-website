      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold">闪电果子（北京）科技有限公司</h3>
            <p className="text-gray-400">专注于智能解决方案的高新技术企业</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center space-x-2">
                ...
                <span className="text-gray-400">contact@shandianguozi.com</span>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center text-gray-400">
          <p>© {new Date().getFullYear()} 闪电果子（北京）科技有限公司. 保留所有权利.</p>
        </div>
      </div>
    </footer>
  );
