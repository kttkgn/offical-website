          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start space-x-3 group">
                <svg className="w-5 h-5 text-blue-400 mt-1 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
                <span className="text-gray-300 leading-relaxed">北京市丰台区泥洼北路6号院9号楼203-354室</span>
              </li>
              <li className="flex items-center space-x-3 group">
                ...
                <a href="mailto:contact@shandianguozi.com" className="text-gray-300 hover:text-blue-400 transition-colors duration-300">
                  contact@shandianguozi.com
                </a>
              </li>
            </ul>
          </div>
